...
export class BeneficiariesService {
  ...
  //             beneficiary.company.companyAddressIsDifferent;
  //           beneficiary.company.totalEmployees = step2.totalEmployees ?? 0;
  ...
  async update(
    ...
    try {
      ...
      if (step1 && (step1.provinceId || step1.communeId)) {
        ...
        if (user.primaryAddress) {
          ...
          const address = addressRepo.create({
            provinceId: step1.provinceId,
            communeId: step1.communeId,
            neighborhood: step1.neighborhood,
            street: step1.zone,
          });
          const savedAddress = await queryRunner.manager.save(address);
          user.primaryAddress = savedAddress;
      ...
      if (step3) {
        ...
        // Employés prévus - 0 est une valeur valide
        existingBeneficiary.plannedEmployeesFemale =
          step3.plannedEmployeesFemale !== undefined
            ? step3.plannedEmployeesFemale
            : existingBeneficiary.plannedEmployeesFemale;
        existingBeneficiary.plannedEmployeesMale =
          step3.plannedEmployeesMale !== undefined
            ? step3.plannedEmployeesMale
            : existingBeneficiary.plannedEmployeesMale;
        existingBeneficiary.plannedPermanentEmployees =
          step3.plannedPermanentEmployees !== undefined
            ? step3.plannedPermanentEmployees
            : existingBeneficiary.plannedPermanentEmployees;
        existingBeneficiary.plannedRefugeeEmployees =
          step3.plannedRefugeeEmployees !== undefined
            ? step3.plannedRefugeeEmployees
            : existingBeneficiary.plannedRefugeeEmployees;
        existingBeneficiary.plannedBatwaEmployees =
          step3.plannedBatwaEmployees !== undefined
            ? step3.plannedBatwaEmployees
            : existingBeneficiary.plannedBatwaEmployees;
        existingBeneficiary.plannedDisabledEmployees =
          step3.plannedDisabledEmployees !== undefined
            ? step3.plannedDisabledEmployees
            : existingBeneficiary.plannedDisabledEmployees;
        existingBeneficiary.plannedAlbinosEmployees =
          step3.plannedAlbinosEmployees !== undefined
            ? step3.plannedAlbinosEmployees
            : existingBeneficiary.plannedAlbinosEmployees;
        existingBeneficiary.plannedRepatriatesEmployees =
          step3.plannedRepatriatesEmployees !== undefined
            ? step3.plannedRepatriatesEmployees
            : existingBeneficiary.plannedRepatriatesEmployees;
        existingBeneficiary.plannedPartTimeEmployees =
          step3.plannedPartTimeEmployees !== undefined
            ? step3.plannedPartTimeEmployees
            : existingBeneficiary.plannedPartTimeEmployees;

        existingBeneficiary.isNewIdea =
          step3.isNewIdea ?? existingBeneficiary.isNewIdea;
        existingBeneficiary.ideaTested =
          step3.ideaTested ?? existingBeneficiary.ideaTested;
        existingBeneficiary.climateActions =
          step3.climateActions ?? existingBeneficiary.climateActions;
        existingBeneficiary.inclusionActions =
          step3.inclusionActions ?? existingBeneficiary.inclusionActions;
